            ...
            <Grid.Column width={10}>
              ...
              <Card className="employee-des">
                <Card.Content>
                  ...
                  <hr/>
                  <div>
                    <h4>Other skills (Detected through resume):</h4>
                    <p>{this.state.employeedata?.skillset==undefined?"Not provided":this.state.employeedata?.skillset}</p>
                  </div>
                </Card.Content>
              </Card>
            </Grid.Column>
