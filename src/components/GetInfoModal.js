            ...
            <Modal.Content className="modal-content">
              <Table className="design-info-table">
                ...
                <Table.Body>
                  ...
                  <Table.Row>
                    <Table.Cell>
                      <p style={{ fontWeight: "700" }}>Resume</p>
                    </Table.Cell>
                    <Table.Cell>
                      <p>{this.props.info?.resume==undefined?"Not provided":this.props.info?.resume}</p>
                    </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <p style={{ fontWeight: "700" }}>Skillset</p>
                    </Table.Cell>
                    <Table.Cell>
                      <p>{this.props.info?.skillset==undefined?"Not provided":this.props.info?.skillset}</p>
                    </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
